...
public class SavedExhibitorDetailPage extends Activity implements OnClickListener {
...
//  Loader image - will be shown before loading image
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		specificExhibitor = new Bookmarked();
		specificExhibitor = (Bookmarked)getIntent().getSerializableExtra("SpecificExhibitor");
        ...
        // Image url
        String image_url = "";
        image_url = constant.WEBSERVICE_URL + constant.EXHIBITOR_IMAGE_URL + specificExhibitor.getReceiver_attendee_image();
        
        ImageLoader imgLoader = new ImageLoader(SavedExhibitorDetailPage.this);
...
//        type_ = ""; //Share - Sh, Save - Sav
	...
	public void onClick(View view) {
		...
		if(view == sendMessage)
		{
			Toast.makeText(SavedExhibitorDetailPage.this, "Coming soon", Toast.LENGTH_SHORT).show();
		}
...
//			new SaveShareAttendee().execute();
	...
	private class SaveShareAttendee extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(SavedExhibitorDetailPage.this);
		...
		protected void onPostExecute(Void result) {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(SavedExhibitorDetailPage.this);
