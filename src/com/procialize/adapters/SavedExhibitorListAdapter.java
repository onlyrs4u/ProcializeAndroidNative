...
public class SavedExhibitorListAdapter extends BaseAdapter{

	private Activity activity;
    private LayoutInflater inflater;
    private List<Bookmarked> exhibitorsList;
    
    Constants constant = new Constants();
//  Loader image - will be shown before loading image
    int loader = R.drawable.ic_launcher;
    
    public SavedExhibitorListAdapter(Activity activity, List<Bookmarked> attendeesList) {
    ...
    public Bookmarked getExhibitorFromList(int position)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bookmarked exhibitors = exhibitorsList.get(position);
